...
<body>
	...
	<header>
		<nav>
			<div id="logo">
				<img src="Images/Saad-removebg-preview.png" alt="Saad Travels Logo">
			</div>
			<div id="nav-elements">
				<ol>
	...
	<section class="hero-video">
		...
		<div class="video-overlay">
			<h1>
				Welcome To Saad Travels <span><%=name%></span>
			</h1>
			<p>Ready for your next adventure? Explore our exclusive
				member-only deals below.</p>
		</div>
	</section>
			...
			<div class="trip-card">
				...
				<div class="trip-info">
					...
					<div class="trip-meta">
						...
						</span> <a href="PackageServlet?destinationId=<%=d.getDestination_id()%>" class="book-now">Book Now</a>
		...
		<div class="trips-grid">
			...
			<div class="trip-card">
				...
				<div class="trip-info">
					...
					<div class="trip-meta">
						<span>June 15-20, 2023</span> <span>$1,299</span>
					</div>
			...
			<div class="trip-card">
				...
				<div class="trip-info">
					...
					<div class="trip-meta">
						<span>August 5-12, 2023</span> <span>$1,899</span>
					</div>
					<a href="#" class="book-now">Manage Booking</a>
				</div>
			</div>
			...
			<div class="trip-card">
				...
				<div class="trip-info">
					...
					<div class="trip-meta">
						<span>October 10-20, 2023</span> <span>$2,499</span>
					</div>
					<a href="#" class="book-now">Manage Booking</a>
				</div>
			</div>
			...
			<div class="trips-grid">
				...
				<div class="trip-card">
					...
					<div class="trip-info">
						...
						<div class="trip-meta">
							<span>Save 25%</span> <span
								style="text-decoration: line-through;">$1,200</span> <span>$899</span>
						</div>
				...
				<div class="trip-card">
					...
					<div class="trip-info">
						...
						<div class="trip-meta">
							<span>Early Bird Discount</span> <span
								style="text-decoration: line-through;">$1,800</span> <span>$1,399</span>
						</div>
						<a href="#" class="book-now">Book Now</a>
					</div>
				</div>
	...
	<section class="content-section">
		...
		<div class="trips-grid">
			<div class="trip-card">
				<div class="trip-info">
					<i class="fas fa-plane-departure fa-3x"
						style="color: goldenrod; margin-bottom: 15px;"></i>
					<h3>Seamless Bookings</h3>
					<p>Quick and hassle-free flight, hotel, and tour bookings with
						instant confirmation.</p>
				</div>
			</div>
			<div class="trip-card">
				<div class="trip-info">
					<i class="fas fa-wallet fa-3x"
						style="color: goldenrod; margin-bottom: 15px;"></i>
					<h3>Affordable Pricing</h3>
					<p>We provide the best deals without compromising on quality or
						comfort.</p>
				</div>
			</div>
			<div class="trip-card">
				<div class="trip-info">
					<i class="fas fa-headset fa-3x"
						style="color: goldenrod; margin-bottom: 15px;"></i>
					<h3>24/7 Support</h3>
					<p>Dedicated travel experts ready to assist you anytime,
						anywhere.</p>
				</div>
			</div>
		</div>
	...
	<section class="content-section">
		...
		<div class="offers-container">
			<p>At Saad Travels, your satisfaction is our priority. Whether
				it's booking assistance, travel tips, or last-minute changes—we’re
				just a call or message away.</p>
			<br>
			<p>
				<strong>Email:</strong> support@saadtravels.com &nbsp; | &nbsp; <strong>Phone:</strong>
				+123 456 7890
			</p>
		</div>
	</section>
	...
	<section class="content-section">
		...
		<div class="offers-container">
			<h3 style="color: goldenrod;">How can I cancel or reschedule a
				trip?</h3>
			<p style="color: burlywood;">Simply login to your account, go to
				"My Trips", and choose the cancel or reschedule option. Policies may
				apply based on service provider.</p>

			<h3 style="color: goldenrod;">Are your deals refundable?</h3>
			<p style="color: burlywood;">Most deals are refundable within 24
				hours of booking. Check the individual offer’s policy for more info.</p>

			<h3 style="color: goldenrod;">Can I travel without a printed
				ticket?</h3>
			<p style="color: burlywood;">Yes! Mobile e-tickets are accepted
				for most bookings. Always confirm based on your destination's
				regulations.</p>
		</div>
	</section>
